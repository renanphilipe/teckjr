// Default content — mirrors the original site exactly
  ...
  pages: {
    hardware: {
      ...
      sections: [
        ...
        {
          id: 's2', title: 'Vídeos e canais de YouTube',
          groups: [
            ...
            { id:'g19', name:'Edy CompCel — Como trocar só a pelicula polarizadora do display', links:[{label:'Link',href:'https://www.youtube.com/watch?v=jvzcq81yExM'}]},
          ]
        }
      ]
    },
    software: {
      ...
      sections: [
        ...
        {
          id: 'sw6', title: 'Vídeos e canais indicados no YouTube',
          groups: [
    ...
    promo: {
      ...
      sections: [
        ...
        {
          id: 'pr3', title: 'Equipamentos de Bancada',
          groups: [
        ...
        {
          id: 'pr5', title: 'Adesivos e Organização',
          groups: [
    ...
    fornecedor: {
      ...
      sections: [
        {
          id: 'fo1', title: 'Contatos dos fornecedores',
          groups: [
            { id:'fo_g1', name:'Bigcell', links:[{label:'WhatsApp',href:'https://wa.me/5581996178483'}], phone:'996178483'},
            { id:'fo_g2', name:'Atacadãocell', links:[{label:'WhatsApp',href:'https://wa.me/5581982723134'}], phone:'982723134'},
            { id:'fo_g3', name:'Romilsoncell', links:[{label:'WhatsApp',href:'https://wa.me/5581996888880'}], phone:'996888880'},
            { id:'fo_g4', name:'Papaléguas', links:[{label:'WhatsApp',href:'https://wa.me/5581986416147'}], phone:'986416147'},
            { id:'fo_g5', name:'Zion / Seventec', links:[{label:'WhatsApp',href:'https://wa.me/5581992968630'}], phone:'992968630'},
            { id:'fo_g6', name:'Inoox', links:[{label:'WhatsApp',href:'https://wa.me/5581989577102'}], phone:'989577102'},
            { id:'fo_g7', name:'Paulistacell', links:[{label:'WhatsApp',href:'https://wa.me/558130103312'}], phone:'30103312'},
        ...
        {
          id: 'fo2', title: 'Recuperação de tela',
          groups: [
            { id:'fo_g10', name:'Redphone', links:[{label:'WhatsApp',href:'https://wa.me/5581983549503'}], phone:'81983549503'},
            { id:'fo_g11', name:'Rodrigo Seventec', links:[{label:'WhatsApp',href:'https://wa.me/5581986220055'}], phone:'81986220055'},
          ]
        },
        {
          id: 'fo3', title: 'Desbloqueio',
          groups: [
            { id:'fo_g12', name:'Rennere', links:[{label:'WhatsApp',href:'https://wa.me/5581988333242'}], phone:'988333242'},
          ]
        }
      ]
    }
...
export function trackView(page) {
  if (typeof window === 'undefined') return
  const key = 'teckjr_views'
  const views = JSON.parse(localStorage.getItem(key) || '{}')
  views[page] = (views[page] || 0) + 1
  views.__total = (views.__total || 0) + 1
  views.__last = new Date().toISOString()
  localStorage.setItem(key, JSON.stringify(views))
}

export function getViews() {
  if (typeof window === 'undefined') return {}
  try { return JSON.parse(localStorage.getItem('teckjr_views') || '{}') } catch { return {} }
}
